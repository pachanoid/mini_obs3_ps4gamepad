...
int motorSpeedX;
int motorSpeedY;
int v=50;    //mini obs3 velocity tweak
...
if ((ctl->axisY() <= -1)||(ctl->axisY() >= 1 ))   {

//motorSpeedY = map(ctl->axisY(), -2, -508, 70, 255);
motorSpeedY = map(ctl->axisY(), -1, 508, 0, 255);
motorSpeedX= map(ctl->axisX(), -1, -508, 0, 255);
  a=0;
  b=0;
//motorSpeedY = ctl->axisY();
//motorSpeedX=ctl->axisX();
...
//Serial.println("motor speed x y ");
...
Serial.println("matematical");
  Serial.println(a);
   ...
   //*******************************************************move motors A/robot forward ************************************************************

   if(a>2){

   a=a+v;        // con 30 funciona bien
a = constrain(a, 0, 255);

    digitalWrite(IN1pin, LOW);
    digitalWrite(IN2pin, HIGH);
    analogWrite(ENApin, a);

    Serial.print("motores A a");
    Serial.println(a);
  
   }

////***************************************************** move motors B/robot forward *****************************************************************
...
b = constrain(b, 0, 255);
 ...
 digitalWrite(IN3pin, LOW);
    digitalWrite(IN4pin, HIGH);
    analogWrite(ENBpin, b);


    Serial.print("motores B a");
    Serial.println(b);

}

//////***************************************************** move motors A/robot backward *****************************************************************
if(a<-2){
